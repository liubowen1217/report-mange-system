...
public interface DistrictService {
     ...
     * @return
     */
    List<District> queryByCodeList(List<String> codeList);
     ...
     * @return
     */
    List<District> queryProvinceAndCity(List<String> codeList);
     ...
     * @return
     */
    List<District> queryByParentCodes(List<String> codeList);
     ...
     * @return
     */
    District queryFirstCity(String code);
     ...
     * @return 结果
     */
    List<District> allDistrictByNames(List<String> districtNames);
}
